class Personal:
    ...
    def setSueldoBasico(self,nuevoBasico):
        if type(nuevoBasico) is float:
            self.__sueldobasico = nuevoBasico
            print('Se ha modificado el sueldo basico de este agente.')
        else:
            print('Error de parametro nuevoBasico en setSueldoBasico. Debe ser float.')